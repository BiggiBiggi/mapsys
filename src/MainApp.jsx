          ...
          element={
            <PrivateRoute>
              <Routes>
                ...
                <Route path="/cellule9/bureaux/etage" element={<Cellule9BureauxEtage />} />
                ...
                <Route path="/cellule11/bureaux/etage" element={<Cellule11BureauxEtage />} />
...
// Application principale avec son propre BrowserRouter
function MainApp() {
  return (
    <BrowserRouter
      future={{

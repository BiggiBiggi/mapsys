...
const ListActions = () => (
  <TopToolbar>
    <CreateButton label="Ajouter un PC Portable" />
    <ExportButton label="Exporter" />
  </TopToolbar>
);

export const PcPortList = () => (
  <List
    actions={<ListActions />}
    filters={PcPortFilters}
    sort={{ field: "nom", order: "ASC" }}
    pagination={<MyPagination />}
    filter={{ type: "PC Portable" }} // filtre automatique par type
  >
...
export const PcPortEdit = () => (
  <Edit title="Modification PC Portable">
...
export const PcPortCreate = () => (
  <Create title="Création PC Portable">
    <SimpleForm toolbar={<CustomToolbar />}>
      <TextInput source="nom" label="Nom du PC" />
      <TextInput source="sn" label="Numéro de série" />
      <TextInput source="prise" label="Prise" />
      <TextInput source="model" label="Modèle" />
      <TextInput source="type" label="Type" defaultValue="PC Portable" />
    </SimpleForm>
  </Create>
);

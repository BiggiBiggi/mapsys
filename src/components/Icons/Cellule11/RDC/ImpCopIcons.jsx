  ...
  return (
    <div>
      <img
        onClick={() =>
          openLink(
            "http://172.27.238.104/web/guest/fr/websys/webArch/mainFrame.cgi"
          )
        }
        onMouseOver={() => handleMouseOver(31, "imp1")}
      ...
      <img
        onClick={() =>
          openLink(
            "http://172.27.238.50/web/guest/fr/websys/webArch/mainFrame.cgi"
          )
        }
        onMouseOver={() => handleMouseOver(22, "imp2")}
        onMouseOut={handleMouseOut}
